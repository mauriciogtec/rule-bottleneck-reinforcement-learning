...
register(id="BuySellText", entry_point="envs:BuySellText", max_episode_steps=20, **kwargs)
register(id="BuySell", entry_point="envs:BuySell2", max_episode_steps=20, **kwargs)
